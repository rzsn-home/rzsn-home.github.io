import { BUILD_VERSION, ALLIANCE_CONFIG, LIVE_NOTICE } from './config.js?v=2026-09-20.9';
import { LANGUAGES, LOCALES, UI, resolveLanguagePreference, translate } from './i18n.js?v=2026-09-20.9';
import { COPY, TASKS, DAILY_GUIDES } from './content.js?v=2026-09-20.9';
import { DAY_ONE_GROUP, SEASON_COPY, SEASON_CONTENT, SEASON_GUIDES, seasonTasks, seasonSynergies, upcoming } from './season.js?v=2026-09-20.9';
import { GUIDE_COPY, GUIDE_TEXT, MEMBER_MEDIA } from './guide-text.js?v=2026-09-20.9';
import { SEASON_LIBRARY_COPY, SEASON_LIBRARY_GUIDES, SEASON_LIBRARY_MEDIA } from './season-library.js?v=2026-09-20.9';
import { DAY_MS, WEEKDAYS, guideState, selectedDate, checklistKey, armsWindow, availableTask, enemyBusterPhase } from './engine.js?v=2026-09-20.9';
import { todayPriorities } from './priority.js?v=2026-09-20.9';
import { createStorage, checkedMap } from './storage.js?v=2026-09-20.9';
